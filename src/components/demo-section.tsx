...
const ttsOptions = [
    { id: "google", name: "Google TTS", icon: "🌐", color: "#4285F4", Icon: Radio, description: "표준 음성 합성" },
    { id: "naver", name: "Naver TTS", icon: "🟢", color: "#03C75A", Icon: Volume2, description: "한국어 최적화" },
    { id: "sam", name: "SAM TTS", icon: "🎙️", color: "#FF6B6B", Icon: Mic, description: "고품질 음성" },
    { id: "custom", name: "User-made TTS", icon: "⚡", color: "#FFD93D", Icon: Wand2, description: "커스텀 음성" },
]
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="bg-discord-1 rounded-lg px-5 py-3 font-mono text-sm border-discord-3 border-2">
                            <div className="flex items-center gap-3 flex-wrap">
                                <img className="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-xs font-bold" src={zakopsa} alt="zakopsa" />
                                ...
                                <div className="flex items-center rounded-md border-primary border-2">
                                    ...
                                    <div className="flex p-2 items-center justify-center bg-discord-3 rounded-r-md">{ttsOptions[selectedSource].name}</div>
                                </div>
                            ...
                            <div className="relative flex items-center justify-center">
                                ...
                                <div className="relative z-10">
                                    <div className="w-40 h-40 md:w-48 md:h-48 rounded-full bg-primary flex items-center justify-center">
                                        <img src={zakopsa} alt="Zakopsa Avatar" className="absolute w-36 h-36 md:w-44 md:h-44 rounded-full object-cover" />
                                    </div>
                                    ...
                                    {ttsOptions.map((option, index) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 md:w-24 md:h-24 rounded-2xl flex flex-col items-center justify-center gap-1 transition-all duration-500 cursor-pointer border-2 ${isSelected
                                                    ? "bg-secondary border-muted-foreground shadow-xl scale-110 ring-4 ring-muted-foreground/20"
                                                    : "bg-secondary/50 border-border hover:bg-secondary hover:border-muted-foreground/50 scale-90"
                                                    }`}
                                                style={{
